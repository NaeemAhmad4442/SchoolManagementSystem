...
$fetchData = myquery($db, "SELECT * FROM notifications WHERE reciever = ".$_SESSION["userid"]."");
...
<?php require "include/navbar.php" ?>
  <div class="content-wrapper">
    ...
    <br><br>
    <?php
    if(empty($fetchData)){ echo "<br>Nessuna notifica";}
    foreach($fetchData as $data)
    {
        ...
        <div class="panel-heading">Nota</div>    
            ...
            <strong>Utente:</strong> '.$student.'<br>
            <strong>Messaggio:</strong> '.$data["message"].' <br>
            <strong>Data/Ora:</strong> '.$data["timestamp"].'<br>
            </div>
        </div>   
        <hr>';
    }
