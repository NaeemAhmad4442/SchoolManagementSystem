...
if(isset($_POST["saveChanges"]))
{
    ...
    $students = myquery($db, "SELECT ID FROM User WHERE classID = (SELECT classID FROM User WHERE ID = ".$_SESSION['userid'].")");
...
<?php require "include/navbar.php" ?>
  <div class="content-wrapper">
    ...
    <br><br><br>
    <form action="send_notfication.php" method="POST">
    <div style="margin-left:400px"><div class="form-group">
        <label for="name">Messaggio</label>
        <textarea style="width:50%" placeholder="Inserisci il nome della classe" name="msg" type="text" required="" class="form-control" id="name"></textarea>
